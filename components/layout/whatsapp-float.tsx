...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 w-[60px] h-[60px] bg-whatsapp rounded-full flex items-center justify-center text-white shadow-lg shadow-whatsapp/40 z-[1000] animate-pulseRing"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
