...
export default async function HotelsPage() {
  const hotelOptions = await getHotels();
  return (
    <>
      <PageHero
        ...
        title="Stay Close to the Haram — and Everywhere Else"
        subtitle="From Kaaba-view 5★ suites to budget-friendly family rooms, booked at rates the public can't get."
      ...
      <section className="px-[5%] py-20 max-w-[1440px] mx-auto">
        <div className="mb-10 text-center">
          ...
          <p className="text-muted-foreground mt-3 text-[15px] max-w-2xl mx-auto">
            ...
            budget — we&apos;ll match you with the right stay.
          </p>
        </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="text-center mt-12">
            <Button asChild size="lg">
              <a href="/contact">Request a Hotel Quote →</a>
            </Button>
          </div>
        </div>
      </section>
      ...
      <CtaStrip
        ...
        subtitle="Send us your dates — we'll come back with options across every budget."
